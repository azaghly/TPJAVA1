...
public class TestBanque {
    ...
    public static void main(String[] args) {
        ...
        CompteBancaire c1 = new CompteBancaire("Yassine",1000,900);
        CompteBancaire c2 = new CompteBancaire("Moha",2000,800);
        CompteBancaire c3 = new CompteBancaire("Yidir",1500,600);
